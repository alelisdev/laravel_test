        ...
        <div class="fixed z-40 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 bottom-0 left-1/2 dark:bg-gray-800 dark:border-gray-800">
            <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
                ...
                <div class="flex items-center justify-center">
                    <button @click="$router.push('/profile/deposit')" data-tooltip-target="tooltip-new" type="button" class="inline-flex items-center justify-center w-10 h-10 font-medium bg-[#ff0000] rounded-full hover:bg-[#ff0000] group focus:ring-4 focus:bg-[#ff0000] focus:outline-none dark:focus:bg-[#ff0000]">
