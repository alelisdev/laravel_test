<template>
    <div class="footer pb-32 md:pb-5 mt-5 footer-color p-4 md:p-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                <div class="col-span-2 md:col-span-1 flex flex-col">
                    <div class="flex justify-between mb-3">
                        ...
                        <div>
                            <img :src="`/assets/images/+18.png`" width="50" alt="">
                        </div>
                    </div>
                    <div v-if="setting">
                        <div class="">
                        ...
                        <div v-if="custom" class="flex  mt-5">
                            ...
                            <div v-if="custom.whastapp" class="flex pl-2">
                                <a :href="custom.whastapp" target="_blank" class="text-3xl text-gray-500 p-3">
        ...
        <div v-if="setting" class="mt-5 flex flex-col justify-start ">
            <p class="text-[3px] w-full"> <div class="eng-license">
            <img src="https://assets.website-files.com/6483631a773f6af2b4edabab/6483631a773f6af2b4edabb4_curacao.png" width="150" loading="eager" alt="" class="ico-brand-type-footer">
            <p class="txt-label text-[10px]">DUCK BET is operated by BritoSistemaBet, company registration number 150731, with registered address at Groot Kwartierweg 10, Curaçao and is licensed and authorized by the Government of Curacao and operates under the Master License of Gaming Services Provider, N.V. #365/JAZ License Number: GLH-OCCHKTW0709172018. Payment agent company is Horangi Trading Limited with address Chytron, 30, 2nd floor, Flat/Office A22, 1075, Nicosia, Cyprus and Registration number: HE 411494.<br><br>Gambling can be addictive. Please play responsibly.only accepts customers over 18 years of age.</p>
         </div>
</p>
            <p class="flex text-[10px] md:text-[12px]  w-full">
<!--                <strong>❤️ Developed by</strong>-->
<!--                <a href="https://www.instagram.com/brittoferrari/" target="_blank" class="ml-2 dark:text-gray-500 dark:hover:text-white transition duration-700 cursor-pointer">-->
<!--                    Pedro Brito-->
<!--                </a>-->
            </p>
        </div>
